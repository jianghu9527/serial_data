...
import com.cn.cd.ruidiculous.company.speark_version_2_application.R;

import cn.wch.ch34xuartdriver.CH34xUARTDriver;

public class MainCH34XActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			Dialog dialog = new AlertDialog.Builder(MainCH34XActivity.this)
					.setTitle("提示")
		...
		openButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (!isOpen) {
					if (!BaseAlication.driver.ResumeUsbList())// ResumeUsbList方法用于枚举CH34X设备以及打开相关设备
					{
						Toast.makeText(MainCH34XActivity.this, "打开设备失败!",
								Toast.LENGTH_SHORT).show();
						BaseAlication.driver.CloseDevice();
					} else {
						if (!BaseAlication.driver.UartInit()) {  //对串口设备进行初始化操作
							Toast.makeText(MainCH34XActivity.this, "设备初始化失败!",
									Toast.LENGTH_SHORT).show();
							Toast.makeText(MainCH34XActivity.this, "打开" +
											"设备失败!",
									Toast.LENGTH_SHORT).show();
							return;
						}
						Toast.makeText(MainCH34XActivity.this, "打开设备成功!",
								Toast.LENGTH_SHORT).show();
						isOpen = true;
		...
		configButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (BaseAlication.driver.SetConfig(baudRate, dataBit, stopBit, parity,//配置串口波特率，函数说明可参照编程手册
						flowControl)) {
					Toast.makeText(MainCH34XActivity.this, "串口设置成功!",
							Toast.LENGTH_SHORT).show();
				} else {
					Toast.makeText(MainCH34XActivity.this, "串口设置失败!",
							Toast.LENGTH_SHORT).show();
				}
			}
		});
		writeButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (retval < 0)
					Toast.makeText(MainCH34XActivity.this, "写失败!",
							Toast.LENGTH_SHORT).show();
			}
		});
